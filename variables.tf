...
EOT
  ...
  type = map(object({
    ...
    log_unmasked_ips_enabled   = optional(bool, false)
    ...
    recommendations_enabled = optional(object({
      acr_authentication               = optional(bool, true)
      agent_send_unutilized_msg        = optional(bool, true)
      baseline                         = optional(bool, true)
      edge_hub_mem_optimize            = optional(bool, true)
      edge_logging_option              = optional(bool, true)
      inconsistent_module_settings     = optional(bool, true)
      install_agent                    = optional(bool, true)
      ip_filter_deny_all               = optional(bool, true)
      ip_filter_permissive_rule        = optional(bool, true)
      open_ports                       = optional(bool, true)
      permissive_firewall_policy       = optional(bool, true)
      permissive_input_firewall_rules  = optional(bool, true)
      permissive_output_firewall_rules = optional(bool, true)
      privileged_docker_options        = optional(bool, true)
      shared_credentials               = optional(bool, true)
      vulnerable_tls_cipher_suite      = optional(bool, true)
    }))
  }))
}
